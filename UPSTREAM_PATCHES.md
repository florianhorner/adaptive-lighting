...
| `17e43e0` / setup-uv v8 | `.github/workflows/install_dependencies/action.yml`, `.github/workflows/docs.yml`, `.github/workflows/markdown-code-runner.yml` | None | Keep existing fork workflows current without changing their policy | `pre-commit run --all-files`; GitHub Actions after PR push | 2026-06-28 | Florian |
